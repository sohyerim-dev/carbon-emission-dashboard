...
| 페이지 | 영상 |
|--------|------|
| 대시보드 | [dashboard-video.mov](./docs/dashboard-video.mov) |
| 기업 분석 | [companies-video.mov](./docs/companies-video.mov) |
| 심층 분석 | [analysis-video.mov](./docs/analysis-video.mov) |
| 탄소세 시뮬레이터 | [simulator-video.mov](./docs/simulator-video.mov) |
| 공시 관리 | [posts-video.mov](./docs/posts-video.mov) |
